package uk.gov.hmcts.labs.chris47dev.controllers;
...
public class RootController {
    ...
    public ResponseEntity<String> welcome() {
        return ok("Welcome to labs-chris47dev java application, my favourite fruit is " +  System.getenv("FAVOURITE_FRUIT"));
    }
}
